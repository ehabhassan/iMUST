      subroutine dverk(odesetid, n, fcn, x, y, xend, tol, ind, c, nw, w)
      implicit none
      integer n, ind, nw, k, odesetid
...
c              first calculate weighted norm y - c(12) - as specified
...
c
  ...
  200       continue
            call fcn(odesetid, n, x + c(18)/6.d0, w(1,9), w(1,2))
c
            do 205 k = 1, n
               w(k,9) = y(k) + temp*(   w(k,1)*74569017600.d0
     +                                + w(k,2)*298276070400.d0  )
  205       continue
            call fcn(odesetid,n, x + c(18)*(4.d0/15.d0), w(1,9), w(1,3))
c
            do 210 k = 1, n
  ...
  210       continue
            call fcn(odesetid, n, x + c(18)*(2.d0/3.d0), w(1,9), w(1,4))
c
            do 215 k = 1, n
  ...
  215       continue
            call fcn(odesetid, n, x + c(18)*(5.d0/6.d0), w(1,9), w(1,5))
c
            do 220 k = 1, n
  ...
  220       continue
            call fcn(odesetid, n, x + c(18), w(1,9), w(1,6))
c
            do 225 k = 1, n
  ...
  225       continue
            call fcn(odesetid, n, x + c(18)/15.d0, w(1,9), w(1,7))
c
            do 230 k = 1, n
  ...
  230       continue
            call fcn(odesetid, n, x + c(18), w(1,9), w(1,8))
c
